...
// silence.
//
// Mr Pepper has no build step: index.html, the ES modules (main, core,
// render, input, audio), soundpack.js, style.css, the manifest, sw.js and the
...
// (catalog.json points at /mr-pepper/icon.png). The SDK and the audio element
// library are NOT here: the launcher origin serves them, and they must never
// be copied in or precached.
//
